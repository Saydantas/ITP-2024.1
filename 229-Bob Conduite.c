...
abaixo que ilustra um conduite) de maneira a passar os dois cabos por dentro dele:
...
int main() {
    ...
    while (T--) {
        int R1, R2;
        scanf("%d %d", &R1, &R2); // Ler os raios dos cabos
        
        // Calcular o menor raio possível do conduite
        int menor_raio = R1 + R2;

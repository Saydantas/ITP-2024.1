...
time. Cada jogador deverá votar se o impeachment deve ou não ocorrer. Se o número de votos 
favoráveis ao impeachment foi maior ou igual a 2/3 (dois terços) do total de jogadores, 
...
N (1 ≤ N ≤ 105), o número de jogadores em seu time. A próxima linha contém N inteiros v1, ...,
vN (vi = 0 ou 1), indicando os votos dos jogadores. O valor 1 indica um voto favorável ao 
impeachment, enquanto o valor 0 indica um voto contrário ao mesmo.
...
int main() {
    ...
    while (scanf("%d", &N) != EOF) {
        ...
        double proporcao = (double)votos_favoraveis / N;
        if (proporcao >= 2.0 / 3.0) {
            printf("impeachment\n");
        } else {
